...
func (s *TransactionService) MoveAllTransactionsBetweenAccounts(c core.Context, uid int64, fromAccountId int64, toAccountId int64) error {
	...
	return s.UserDataDB(uid).DoTransaction(c, func(sess *xorm.Session) error {
		...
		return s.moveAllTransactionsBetweenAccounts(c, sess, uid, fromAccount, toAccount)
	})
}

// moveAllTransactionsBetweenAccounts moves all transactions and related transactions
// of the given from account to the given to account within the given database session
func (s *TransactionService) moveAllTransactionsBetweenAccounts(c core.Context, sess *xorm.Session, uid int64, fromAccount *models.Account, toAccount *models.Account) error {
